            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <!--begin::Heading-->
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Panel</h1>
                        <!--end::Title-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <div class="d-flex flex-stack mb-2">
                            ...
                            <!--end::Label-->
                            <!--begin::Link-->
                            <a href="../../demo6/dist/authentication/flows/basic/password-reset.html"
                    ...
                    <div class="text-center">
                        <!--begin::Submit button-->
                        <button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-warning  ">
                            <span class="indicator-label">Sing in</span>
                ...
                success: function (res, status, xhr, $form) {
                    ...
                    setTimeout(function () {
                        if (res.error) {
                            ...
                            location.href = "{{URL::to('/')}}/panel/certificates";
                        }
                    }, 300);
                },
